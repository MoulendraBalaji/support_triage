...
class SupportTriageEnv(
    ...
    Example:
        ...
        ...
        ...     result = client.step(SupportTriageAction(message="Hello!"))
        ...     print(result.observation.echoed_message)

    Example with Docker:
        >>> # Automatically start container and connect
        >>> client = SupportTriageEnv.from_docker_image("support_triage-env:latest")
        >>> try:
        ...     result = client.reset()
        ...     result = client.step(SupportTriageAction(message="Test"))
        ... finally:
        ...     client.close()
    """
